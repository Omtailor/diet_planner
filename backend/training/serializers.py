...
class ExerciseSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'duration_minutes', 'instructions', 'calories_burned_per_min',
        ]
...
class DayTrainingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DayTraining
        fields = [
            'id', 'day_of_week', 'day_name', 'date',
            'is_rest_day', 'exercises',
...
class TrainingPlanSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TrainingPlan
        fields = [
            'id', 'week_start_date', 'is_active',
            'created_at', 'day_trainings',
        ]