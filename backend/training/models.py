...
class Exercise(models.Model):
    ...
    equipment = models.CharField(max_length=10, choices=EQUIPMENT_CHOICES, default='none')
...
class DayTraining(models.Model):
    ...
    training_plan = models.ForeignKey(TrainingPlan, on_delete=models.CASCADE, related_name='day_trainings')
