...
class UserProfile(models.Model):
    ...
    # Basic Info
    gender = models.CharField(max_length=10, choices=GENDER_CHOICES, default='male')  # ← ADDED
    ...
    diet_preference = models.CharField(max_length=10, choices=DIET_CHOICES, default='veg')

    # Beverage
    beverage_habit = models.CharField(max_length=10, choices=BEVERAGE_CHOICES, default='none')
    tea_type = models.CharField(max_length=10, choices=TEA_TYPE_CHOICES, blank=True, null=True)
    coffee_type = models.CharField(max_length=10, choices=COFFEE_TYPE_CHOICES, blank=True, null=True)
